...
# Create the kubeconfig content with insecure-skip-tls-verify (no CA cert)
...
# Save to file
echo "$KUBECONFIG_CONTENT" > minikube-ngrok-insecure-fixed-kubeconfig.yaml
echo "✅ Created insecure kubeconfig: minikube-ngrok-insecure-fixed-kubeconfig.yaml"

# Test the kubeconfig
echo "🧪 Testing kubeconfig..."
export KUBECONFIG=minikube-ngrok-insecure-fixed-kubeconfig.yaml
